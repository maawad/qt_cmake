...
class ptx_highlighter : public QSyntaxHighlighter {
 public:
  ptx_highlighter(QTextDocument *parent = 0) : QSyntaxHighlighter(parent) {
    ...
    const QString instructions[] = {QStringLiteral("\\badd\\b"),
                                    QStringLiteral("\\bsub\\b"),
                                    QStringLiteral("\\bld\\b"),
                                    QStringLiteral("\\bst\\b"),
                                    QStringLiteral("\\batom\\b"),
                                    QStringLiteral("\\bmad\\b"),
                                    QStringLiteral("\\bmov\\b"),
                                    QStringLiteral("\\bbfind\\b"),
                                    QStringLiteral("\\bset\\b"),
                                    QStringLiteral("\\bpopc\\b"),
                                    QStringLiteral("\\bshfl\\b"),
                                    QStringLiteral("\\bsync\\b"),
                                    QStringLiteral("\\bbra\\b"),
                                    QStringLiteral("\\buni\\b"),
                                    QStringLiteral("\\bvote\\b"),
                                    QStringLiteral("\\bballot\\b"),
                                    QStringLiteral("\\bsetp\\b"), 
                                    QStringLiteral("\\bne\\b"),
                                    QStringLiteral("\\beq\\b"),
                                    QStringLiteral("\\bidx\\b"),
                                    QStringLiteral("\\brelaxed\\b"),
                                    QStringLiteral("\\bgpu\\b"),
                                    QStringLiteral("\\bmul\\b"),
                                    QStringLiteral("\\bwide\\b"),
                                    QStringLiteral("\\bparam\\b"),
                                    QStringLiteral("\\breg\\b"),
